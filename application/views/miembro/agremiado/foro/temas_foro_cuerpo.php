            ...
            <div class="col-lg-9">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Temas - Foro Colectivo</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        <div class="col-lg-1">
                                            <img class="direct-chat-img" src="<?php echo base_url(); ?>images/images_perfil/PU_unifrancouni.jpg"
                                                 alt="message user image" style="height: 30px !important; width: 30px !important;">
                                        </div>
                                        <h3 class="box-title">Aquí el nombre del tema</h3>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                Aquí la Descripcion Detallada<hr>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                    ...
                                    <div class="box-footer with-border">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <i class="fa fa-share"></i> Respuestas (0)
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <button class="btn btn-box-tool" style="float: right !important;">
                                                    <i class="fa fa-pencil"></i>
                                                </button>
                                                <button class="btn btn-box-tool" style="float: right !important;">
                                                    <i class="fa fa-times"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-11">
                                                <input type="text" class="form-control" placeholder="Responde...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
